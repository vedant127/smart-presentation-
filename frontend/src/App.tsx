...
import { Sparkles, Settings, Folder, Database } from 'lucide-react';
        ...
        <header className="border-b border-slate-800 bg-surface/50 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/admin/data" className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-400 hover:text-white transition-colors">
